  ...
  de: {
    ...
    projects: {
      ...
      items: {
        project1: {
          title: 'Projekt Eins',
          description: 'Eine kurze Beschreibung Ihres ersten Projekts. Welche Technologien haben Sie verwendet? Welche Probleme haben Sie gelöst?'
        },
        project2: {
          title: 'Projekt Zwei',
          description: 'Beschreibung Ihres zweiten Projekts. Heben Sie die wichtigsten Funktionen und Ihre Rolle in der Entwicklung hervor.'
        },
        project3: {
          title: 'Projekt Drei',
          description: 'Details zu Ihrem dritten Projekt. Was macht es einzigartig? Was haben Sie gelernt?'
        }
      }
    },
    cv: {
